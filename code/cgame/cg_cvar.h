...
// Note that this one is a float.
CG_CVAR( cg_gibsInheritPlayerVelocity, "cg_gibsInheritPlayerVelocity", "1", CVAR_ARCHIVE )
CG_CVAR( cg_gibsMaxRandomVelocity, "cg_gibsMaxRandomVelocity", "125", CVAR_ARCHIVE )
CG_CVAR( cg_gibsRandomVelocityBasedOnPlayerSpeed, "cg_gibsRandomVelocityBasedOnPlayerSpeed", "0.5", CVAR_ARCHIVE )
