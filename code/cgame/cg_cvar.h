...
CG_CVAR( cg_drawScores, "cg_drawScores", "1", CVAR_ARCHIVE )
CG_CVAR( cg_drawStatusHead, "cg_drawStatusHead", "1", CVAR_ARCHIVE )
CG_CVAR( cg_statusScale, "cg_statusScale", "1", CVAR_ARCHIVE )
CG_CVAR( cg_fovGunAdjust, "cg_fovGunAdjust", "0", CVAR_ARCHIVE )
