...
CG_CVAR( cg_gibsRandomVelocityFromDamageScale, "cg_gibsRandomVelocityFromDamageScale", "1.0", CVAR_ARCHIVE )
CG_CVAR( cg_gibsExtraRandomVelocity, "cg_gibsExtraRandomVelocity", "150", CVAR_ARCHIVE )
