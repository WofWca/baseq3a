...
G_CVAR( g_randomQuadBaseChance, "g_randomQuadBaseChance", "0.02", 0, 0, qtrue, qfalse )
G_CVAR( g_randomQuadMeleeBaseChance, "g_randomQuadMeleeBaseChance", "0.15", 0, 0, qtrue, qfalse )
