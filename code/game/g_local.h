...
struct gentity_s {
	...
	void		(*die)(gentity_t *self, gentity_t *inflictor, gentity_t *attacker, vec3_t damageDir, int damage, int mod);
...
void player_die (gentity_t *self, gentity_t *inflictor, gentity_t *attacker, vec3_t damageDir, int damage, int mod);
