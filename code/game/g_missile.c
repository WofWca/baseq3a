...
================
*/
static void ProximityMine_Die( gentity_t *ent, gentity_t *inflictor, gentity_t *attacker, const vec3_t dir, int damage, int mod ) {
...
gentity_t *fire_plasma (gentity_t *self, vec3_t start, vec3_t dir) {
	...
	bolt = G_SpawnFromEntPool( ENTPOOL_PLASMA );
...
gentity_t *fire_grenade (gentity_t *self, vec3_t start, vec3_t dir) {
	...
	bolt = G_SpawnFromEntPool( ENTPOOL_GRENADE );
...
gentity_t *fire_bfg (gentity_t *self, vec3_t start, vec3_t dir) {
	...
	bolt = G_SpawnFromEntPool( ENTPOOL_BFG );
	bolt->classname = "bfg";
	bolt->nextthink = level.time + 10000;
	bolt->think = G_ExplodeMissile;
	bolt->s.eType = ET_MISSILE;
...
gentity_t *fire_rocket (gentity_t *self, vec3_t start, vec3_t dir) {
	...
	bolt = G_SpawnFromEntPool( ENTPOOL_ROCKET );
